...
public class DefaultHeaderTransformer extends HeaderTransformer {
	...
	public void onViewCreated(Activity activity, View headerView) {
		...
		mHeaderProgressBar = (PullToRefreshProgressBar) headerView
		...
		mProgressCornerRadius = activity.getResources().getDimensionPixelSize(
	...
	private void setupViewsFromStyles(Activity activity, View headerView) {
		...
		if (styleAttrs
				.hasValue(R.styleable.PullToRefreshHeader_ptrProgressBarCornerRadius)) {
			mProgressCornerRadius = (float) styleAttrs.getDimensionPixelSize(
					R.styleable.PullToRefreshHeader_ptrProgressBarCornerRadius,
					0);
		}
	...
	private void applyProgressBarSettings() {
		if (mHeaderProgressBar != null) {
			...
			mHeaderProgressBar
					.setProgressBarCornerRadius(mProgressCornerRadius);
		}
	}
